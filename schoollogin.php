...
<html>
	...
	<body>
		<div class="container">
			<div class="schlogin-maindiv-form">
				<div class="schlogin-heading text-center text-white text-uppercase"><h4 class="animated heartBeat">School login</h4></div>
				<form action="schoolloginvalidation.php" method="post" class="needs validation">
					...
					<div class="forregister">
						<div class="form-group">
							<label>School who have not register</label>
							<a href="schoolreg.php">click here</a>
						</div>
					</div>
