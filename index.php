		...
		<section class="my-4 ">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-12">
					<div class=" upcomingheading py-4 text-center" id="aboutus">
					...
					<div class="col-lg-4 col-md-4 col-12">
						<div class="card cardclass bg-light my-2" style="height: 300px">
							...
							<div class="card-body">
								...
								<button class="btn btn-danger"><a class="text-white"  href="studentdashboard.php">login to join</a></button>
							</div>
						</div>
					</div>
