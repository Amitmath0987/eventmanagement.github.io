...
<html>
<head>
	<title>Badminton participants</title>
	<?php
...
<div class="col-lg-12 col-md-12 col-12">
	<h1 class="text-center text-danger text-uppercase">Badminton participants</h1>
...
$qy="select *from originparticipants where event_name='Badminton'";
