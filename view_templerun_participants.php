...
<html>
<head>
	<title>Temple Run participants</title>
	<?php
...
<div class="col-lg-12 col-md-12 col-12">
	<h1 class="text-center text-danger text-uppercase">Temple Run participants</h1>
...
$qy="select *from originparticipants where event_name='Temple Run'";
