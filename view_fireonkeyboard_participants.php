...
<html>
<head>
	<title>Fire on Keyboard participants</title>
	<?php
...
<div class="col-lg-12 col-md-12 col-12">
	<h1 class="text-center text-danger text-uppercase">Fire on Keyboard participants</h1>
...
$qy="select *from originparticipants where event_name='Fire on Keyboard'";
