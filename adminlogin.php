...
<html>
	...
	<body>
		<div class="container">
			<div class="ad-maindiv-form">
				<div class="admin-heading text-center text-white text-uppercase"><h4 class="animated heartBeat">admin login</h4></div>
				<form action="adminloginvalidation.php" method="post" class="needs validation">
					...
					<div class="forregister">
						<div class="form-group">
							...
							<a href="adminreg.php">click here</a>
						</div>
					</div>
